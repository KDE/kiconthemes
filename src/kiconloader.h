...
public:
     ...
     *
     * \value States::DefaultState The default state.
     * \value States::ActiveState Icon is active.
     * \value States::DisabledState Icon is disabled.
     * \value [since 5.22] States::SelectedState Icon is selected.
     * \value States::LastState Last state (last constant)
     */
    enum States {
        DefaultState,
        ActiveState,
     ...
     * \a pixmap to draw on
     * \since 4.7
     * \deprecated [6.5] use KIconUtils::addOverlays from KGuiAddons
     */
